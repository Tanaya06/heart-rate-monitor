...
const char* host = "Web Service Hostname";
const int port = 5192;                        //Web Service Port Number
// We now create a URI for the request
String url = "POST /MyService/GetValue?BPM="; //Web Service Post request URL
...
void loop() {
    if(msTime>10000)
    {
        ...
        client.print(url + BPM +" HTTP/1.1\r\n" + "Host: " + host + "\r\n\r\n");
        Serial.println(url + BPM +" HTTP/1.1\r\n" + "Host: " + host + "\r\n\r\n");
